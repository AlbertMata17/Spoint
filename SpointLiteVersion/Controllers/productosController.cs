...
namespace SpointLiteVersion.Controllers
{
    public class productosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idProducto,codigobarra,Descripcion,idtipo,Precio,itbis,costo,nota,descuento")] productos productos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idProducto,codigobarra,Descripcion,idtipo,Precio,itbis,costo,nota,descuento")] productos productos)
        {
            if (ModelState.IsValid)
            {
